...
urlpatterns = [
    ...
    path('role_delete/', views.role_delete, name='role_delete'),  # 授权角色
    ...
    path('menu_find/', views.menu_find, name='menu_find'),  # 菜单信息查找
    path('menu_add/', views.menu_add, name='menu_add'),  # 新增菜单信息
    path('menu_info/', views.menu_info, name='menu_info'),  # 查看菜单信息
    path('menu_edit/', views.menu_edit, name='menu_edit'),  # 编辑菜单信息
    path('menu_delete/', views.menu_delete, name='menu_delete'),  # 删除菜单信息
    ...
    path('user_edit/', views.user_edit, name='user_edit'),  # 用户信息修改
